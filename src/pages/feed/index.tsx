...
//   );
  ...
  return (
    ...
    >
        <p>Username</p>
        <div>
            {image && <img alt = "some-alt-text" className="max-w-[3rem]" src={image}></img>}
        </div>
    <h3 className="text-2xl font-bold">Title of Shout-Out</h3>
    <div className="text-lg">
        This is the body of this shout-out. Lorem ipsum shoutout all my favorite people blah blah check out my placeholder copy I love this cohort omg!!
    </div>
    <button
